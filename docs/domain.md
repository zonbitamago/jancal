...
**関数:** `calculateScore({required int fu, required int han, required bool isParent, required bool isTsumo}) → ScoreResult`
...
| 問題ID | problem.dartの回答 | 正しい計算結果 | 原因 |
|--------|-------------------|---------------|------|
