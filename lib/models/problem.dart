...
const allProblems = <Problem>[
  ...
  Problem(
    ...
    correctAnswer: '1000',
    choices: ['1000', '1300', '2000', '2600'],
    hint: '30符1翻 子のロン → 1000点。白ポンの役牌。明刻4符+単騎2符+副底20=26→30符。',
    openGroups: [0],
  ),
  ...
  Problem(
    ...
    isTsumo: false,
    correctAnswer: '2000',
    choices: ['1000', '2000', '2600', '5200'],
    hint: '30符2翻 子のロン → 2000点。中ポン+ドラ1。明刻4符+単騎2符+副底20=26→30符。',
    openGroups: [0],
  ),
  // 中級：トイトイ（鳴き）
  Problem(
  ...
  Problem(
    ...
    correctAnswer: '2000',
    choices: ['1000', '2000', '2600', '5200'],
    hint: '30符2翻 子のロン → 2000点。鳴き三色(1翻)+發ポン(1翻)。',
    openGroups: [0, 3],
  ),
  // 上級：清一色（食い下がり5翻）
  Problem(
